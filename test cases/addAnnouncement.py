...
time.sleep(1)
driver.find_element(By.XPATH, '/html/body/div/div/div/switch/div/div[2]/a[2]').click()
time.sleep(0.5)
title=driver.find_element(By.XPATH, '//*[@id="root"]/div/div/switch/div/form/input')
title.send_keys("Deneme Test to Announcement  Title")
content=driver.find_element(By.XPATH, '//*[@id="root"]/div/div/switch/div/form/textarea')
content.send_keys("Deneme Test to Announcement Content")
driver.find_element(By.XPATH, '//*[@id="root"]/div/div/switch/div/form/button').click()
